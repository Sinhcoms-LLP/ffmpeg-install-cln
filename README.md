...
======================================================
    ...
    Script:    Sinhcoms LLP https://www.sinhcoms,in
...
### How to install (ffmpeg-install):
  ...
  * **Instructions:**
    ...
    * Open the terminal.
    * Clone the repository: `git clone https://github.com/Sinhcoms-LLP/ffmpeg-install-cln.git`
...
### The fastest way to install 
    ...
    1：wget https://raw.githubusercontent.com/Sinhcoms-LLP/ffmpeg-install-cln/master/ffmpeg-install
